...
```java
package com.lucky.lk.gateway.controller;
...
public class FallbackController {
    ...
    public ResponseEntity<String> fallbackA() {
        return new ResponseEntity<>("服务暂时不可用", HttpStatus.BAD_REQUEST);
    }

    @GetMapping("/good/1/view")
...
```java
package com.lucky.lk.gateway.config;
